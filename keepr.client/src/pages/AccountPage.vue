...
<div class="container-fluid">
  <section class="row">
    ...
    <div class="col-10 m-auto">
      <h2>Vaults</h2>
      <section class="row">
        <div v-for="vault in myVaults" :key="vault.id" class="col-3 elevation-3 selectable" style="height: 150px; background-repeat: no-repeat; background-position: center; background-size: cover;" :style="`background-image: url(${vault.img})`">
          <VaultKeepCardComponent :vault = "vault"/>
        </div>
      </section>
    </div>
    ...
    <div class="col-10 m-auto">
      <h3>Keeps</h3>
      <section class="row">
        <div v-for="keep in myKeeps" :key="keep.id" class="col-3 elevation-3 selectable" style="height: 250px; background-repeat: no-repeat; background-position: center; background-size: cover;" :style="`background-image: url(${keep.img})`">
